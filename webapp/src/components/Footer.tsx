      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">CodeLore</span>
            </div>
            <p className="text-gray-400 text-base">
              Understand any codebase instantly with AI-powered insights.
              Codelore analyzes repositories and generates comprehensive narratives.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link href="/guides" className="text-base text-gray-400 hover:text-white">
                      Guides
                    </Link>
                  </li>
                  <li>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link href="/licenses" className="text-base text-gray-400 hover:text-white">
                      Licenses
                    </Link>
                  </li>
                </ul>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {new Date().getFullYear()} CodeLore. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
